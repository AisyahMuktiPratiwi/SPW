 ...
 <div class="container">
      ...
      <div class="col-md-7 py-5 wrap-about pb-md-5 ftco-animate">
        <div class="heading-section-bold mb-4 mt-md-5">
          <div class="ml-md-0">
                 <marquee direction="left" behavior="slide" scrollamount="80" width="500px"> <h1 class="mb-4" style="color: rgb(201, 0, 0);"><b>Selamat Datang di Toko <br>Online Le zato</b></h1></marquee>
          </div>
