...
<body>
    ...
    <div class="section">
        <div class="container" style="color: white;margin-top:5rem; margin-right:3rem;">
            <div class="box">
                ...
                <a href="" style="color: inherit;">
                    <div class="col-5">
                        <img src="{{asset('template/dist/img/seblak.png') }}" width="150px;" style="margin-bottom: 5px;">
                    </div>
                </a>
                <a href="" style="color: inherit;">
                    <div class="col-5">
                        <img src="{{asset('template/dist/img/tapoki.png') }}" width="150px;" style="margin-bottom: 5px;">
                    </div>
                </a>
            </div>
        </div>
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="hh">
                <div class="col-3">
                    <div class="card" style="width: 18rem; margin-top:2rem; margin-bottom:2rem; background-color:white;padding-right:2rem;">
                        <img src="{{ asset('gambarproduk/'.$row->gambar)}}" style="height:15rem; width:15rem; margin-left:1rem; margin-top:1rem" class="card-img-top" alt="...">
                        <div class="card-body">
                            <h5 class="card-title" style="color: rgb(173, 0, 0);">{{ $row->nama }}</h5>
                            <p class="card-text"><button type="button" class="btn btn-sm" style="margin-left:8rem;border-radius: 150px;background-color:rgb(255, 110, 110);color:white">Rp.{{ $row->harga }}-</button></p>
                            <a href="/detail/{{ $row->id}}" class="btn" style="background-color:rgb(160, 189, 221);color:white">Detail</a>
                            <a href="{{ route('add.to.cart', $row->id) }}" class="btn" style="background-color:mediumseagreen"><img src="{{ asset('template/dist/img/a.png') }}" alt="" style="width:30px;"></a>
                        </div>
                    </div>
                </div>
            </div>
