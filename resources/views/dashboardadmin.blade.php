    ...
    <div class="content-wrapper" style="background-color:rgb(255, 247, 247);">
        ...
        <section class="content">
            <div class="container-fluid">
                ...
                <div class="box" style="background-color: white;border:1px solid rgb(201, 0, 0);; height:20rem;	padding:1px;box-sizing: border-box;margin: 10px 0;">
                    <h2 style="color:rgb(201, 0, 0);; margin-left: 20px; text-align:center; margin-top:5rem">Selamat Datang di Le Zato</h2>
                </div>
